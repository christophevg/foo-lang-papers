...
\begin{tikzpicture}[scale=1,tdplot_main_coords]
  % axis
  \draw[very thick,->] (0,0,0) -- (7,0,0) node[anchor=north east,xshift=8mm]{$flexibility$};
  \draw[very thick,->] (0,0,0) -- (0,7,0) node[anchor=north west]{$update$};
  ...
  \draw[dashed] (cg)       -- (6,4.5,0);
  % "balls"
  % 1. ideal
  \tdplottransformmainscreen{6}{0}{0}
  \shadedraw[tdplot_screen_coords, ball color=lightgray,draw=lightgray]
    (\tdplotresx,\tdplotresy) circle (0.20)
    node[above,xshift=+5pt,yshift=+5pt,text=gray]{\footnotesize ideal};
  % 2. VM
  \tdplottransformmainscreen{2}{2}{2}
  \shadedraw[tdplot_screen_coords, ball color=lightgray,draw=lightgray]
    (\tdplotresx,\tdplotresy) circle (0.20)
    node[above,yshift=+7pt,text=gray]{\footnotesize virtual machine};
  % 3. modular
  \tdplottransformmainscreen{4}{4}{4}
  \shadedraw[tdplot_screen_coords, ball color=lightgray,draw=lightgray]
    (\tdplotresx,\tdplotresy) circle (0.20)
    node[left,xshift=-5pt,text=gray]{\footnotesize modular native image};
  % 4. reconfig
  \tdplottransformmainscreen{4}{2}{4}
  \shadedraw[tdplot_screen_coords, ball color=lightgray,draw=lightgray]
    (\tdplotresx,\tdplotresy) circle (0.20)
    node[above,yshift=+7pt,text=gray]{\footnotesize reconfigurable virtual machine};
  % 5. full
  \tdplottransformmainscreen{6}{6}{4}
  \shadedraw[tdplot_screen_coords, ball color=lightgray,draw=lightgray]
    (\tdplotresx,\tdplotresy) circle (0.20)
    node[right,xshift=+5pt,text=gray]{\footnotesize full native image};
  % 5. cg
  \tdplottransformmainscreen{6}{4.5}{3}
  \shadedraw[tdplot_screen_coords, ball color=gray,draw=black]
    (\tdplotresx,\tdplotresy) circle (0.20)
    node[right,xshift=+5pt,text=black,align=center]{\footnotesize code generation};
\end{tikzpicture}
