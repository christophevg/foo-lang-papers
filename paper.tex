...
for the application of a domain specific language (DSL). This paper propose
such a DSL to describe these algorithms in a formal and functional way. This
allows for the automation of the fusion of these algorithms on a functional
level though code generation. The more optimally fused code, produced by a
prototype code generator implementation, shows to have less impact on e.g. the
execution time of the resulting intrusion detection system and its use of the
wireless network, in comparison with a basic side-by-side implementation of the
same algorithms.
