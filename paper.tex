...
number of bytes sent over the network is reduced by 7\%. Finally, the execution
time is also improved by 7\%.
...
IDS. We see opportunities for applications who detect intrusion, to actively
